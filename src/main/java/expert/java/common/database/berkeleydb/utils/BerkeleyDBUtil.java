package expert.java.common.database.berkeleydb.utils;
...
public class BerkeleyDBUtil {
    static Logger log = Logger.getLogger(BerkeleyDBUtil.class.getName());
    ...
    public boolean writeToDatabase(String key, String value, boolean isOverwrite) {
        try {
            ...
            } catch (DeadlockException lockConflict) {
                txn.abort();
